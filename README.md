...
5. **Tối ưu hình ảnh v3.1:** Áp dụng thuật toán Re-scaling Lanczos4 kết hợp bộ lọc Sharpening (Unsharp Mask) để khôi phục các chi tiết mô học bị mất trong quá trình nén ảnh, tăng cường độ nét cho các vùng biểu biến tổn thương.
...
3. Tài nguyên máy chủ Cloud (Render) giới hạn ở mức 512MB RAM, yêu cầu cấu hình tối ưu hóa luồng Python Native để tránh tràn bộ nhớ.
